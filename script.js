...
(function () {
  ...
  var translations = {
    de: {
      ...
      hintCompareFoot: "Unverbindliche Schätzung auf Basis deiner Eingaben und voreingestellten Beispielwerte. Bitte Eingaben und Ergebnisse prüfen. Reale Kosten können abweichen.",
      hintSingleFoot: "Unverbindliche Schätzung auf Basis deiner Eingaben und voreingestellten Beispielwerte. Bitte Eingaben und Ergebnisse prüfen. Reale Kosten können abweichen.",
      ...
      footerNote: "Unverbindliche Beispielrechnung. Eingaben und Ergebnisse vor Entscheidungen prüfen. Keine vollständige Gesamtkostenberechnung. Eingaben lokal gespeichert.",
      ...
      longtermFootnote: "Unverbindliche Beispielrechnung. Nur Energie-/Kraftstoffkosten. Anschaffung nur als Mehrpreis berücksichtigt; Wartung, Versicherung, Steuern, Wertverlust, Ladeverluste und Grundgebühren sind nicht enthalten. Tatsächliche Gesamtkosten können stark abweichen.",
      ...
      shareImgDisclaimer: "Unverbindliche Beispielrechnung · Eingaben prüfen.",
      ...
      shareTextDisclaimer: "Hinweis: Unverbindliche Schätzung auf Basis deiner Eingaben. Bitte Eingaben und Ergebnis prüfen. Nur Energie-/Kraftstoffkosten; Wartung, Versicherung, Steuern, Wertverlust, Ladeverluste und Grundgebühren sind nicht enthalten.",
    ...
    en: {
      ...
      hintCompareFoot: "Non-binding estimate based on your inputs and pre-set example values. Check inputs and results. Actual costs may differ.",
      hintSingleFoot: "Non-binding estimate based on your inputs and pre-set example values. Check inputs and results. Actual costs may differ.",
      ...
      footerNote: "Non-binding example calculation. Check inputs and results before decisions. Not a complete total-cost calculation. Inputs are stored locally.",
      ...
      longtermFootnote: "Non-binding example calculation. Energy/fuel costs only. Purchase price is considered only as a price premium; maintenance, insurance, taxes, depreciation, charging losses and base fees are not included. Actual total costs may differ significantly.",
      // Feedback hints
      ...
      shareImgDisclaimer: "Non-binding example calculation · Check inputs.",
      ...
      shareTextDisclaimer: "Note: Non-binding estimate based on your inputs. Check the inputs and result. Energy/fuel costs only; maintenance, insurance, taxes, depreciation, charging losses and base fees are not included.",
    ...
    tr: {
      ...
      hintCompareFoot: "Girdilerine ve önceden tanımlanmış örnek değerlere dayalı bağlayıcı olmayan tahmindir. Girdileri ve sonuçları kontrol edin. Gerçek maliyetler değişebilir.",
      hintSingleFoot: "Girdilerine ve önceden tanımlanmış örnek değerlere dayalı bağlayıcı olmayan tahmindir. Girdileri ve sonuçları kontrol edin. Gerçek maliyetler değişebilir.",
      ...
      footerNote: "Bağlayıcı olmayan örnek hesaplama. Karar vermeden önce girdileri ve sonuçları kontrol edin. Tam toplam maliyet hesabı değildir. Girdiler yerel olarak saklanır.",
      ...
      longtermFootnote: "Bağlayıcı olmayan örnek hesaplama. Yalnızca enerji/yakıt maliyetleri. Satın alma bedeli yalnızca fiyat farkı olarak dikkate alınır; bakım, sigorta, vergiler, değer kaybı, şarj kayıpları ve sabit ücretler dahil değildir. Gerçek toplam maliyetler önemli ölçüde farklı olabilir.",
      // Feedback
      ...
      shareImgDisclaimer: "Bağlayıcı olmayan örnek hesaplama · Girdileri kontrol edin.",
      ...
      shareTextDisclaimer: "Not: Girdilerine dayalı bağlayıcı olmayan tahmindir. Girdileri ve sonucu kontrol edin. Yalnızca enerji/yakıt maliyetleri; bakım, sigorta, vergiler, değer kaybı, şarj kayıpları ve sabit ücretler dahil değildir.",
      // Result sentence (legally qualified, used in result/share/share-image)
